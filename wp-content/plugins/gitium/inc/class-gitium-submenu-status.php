   ...
   private function show_git_changes_table_submit_buttons( $changes ) {
        ...
        if ( !empty( $changes ) ) : ?>
            <p>
                ...
                <input type="text" name="commitmsg" id="save-changes" class="widefat" value="" placeholder="<?php printf( 'Merged changes from %s on %s', esc_url(get_site_url()), esc_html( gmdate( 'm.d.Y' ) )); ?>" />
            </p>
            <p>
